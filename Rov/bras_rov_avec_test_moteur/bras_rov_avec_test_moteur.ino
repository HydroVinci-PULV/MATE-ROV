...
void setup() {
  ...
  pwm.writeMicroseconds(5, 1500);  // send "stop" signal to ESC. Also necessary to arm the ESC.
...
void loop() {
  ...
  //Serial.print("P0: ");
  int val0Calibrated = constrain(val0, 0, 1023);
  int pwmval0 = map(val0, 0, 1023, 1100, 1900);
  //Serial.print(pwmval0);
  pwm.writeMicroseconds(5, pwmval0);
  //pwm.setPWM(5, 0, pwmval0);
  delay(5);
  previousVal0 = val0;
